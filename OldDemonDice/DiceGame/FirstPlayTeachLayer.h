...
@interface FirstPlayTeachLayer : CCLayer <SuperDiceGameboardDelegate>{
	int totalScore;	//總分數
    ...
    EnumEventCount firstPlayNumber;
    BOOL lockRedButton ;
    BOOL lockChangeContext;
    BOOL lockChangeTalkBubble;
    BOOL lockDiceBufferArea;
    BOOL lockPlayDiceLayer;
    
    CCMenu *backToSingleGameButton;
    int countText;
    
    CCSprite *tempShowSprite;
