...
-(void)loadData{
	...
	name = [playerDatas[0] copy];
    firstPlay = [playerDatas[1] intValue];
    storySchedule = [playerDatas[2] intValue];
    albumIntArray[0] = [playerDatas[3] intValue];
    albumIntArray[1] = [playerDatas[4] intValue];
    albumIntArray[2] = [playerDatas[5] intValue];
    albumIntArray[3] = [playerDatas[6] intValue];
    albumIntArray[4] = [playerDatas[7] intValue];
    albumIntArray[5] = [playerDatas[6] intValue];
